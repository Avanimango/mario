...
gameStatus = "start"
document.getElementById("status").innerHTML = "game is loading please be paitient"
...
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press Any Start Keys to Start and Play ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
  ...
  if(gameConfig.status==='gameover'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("GAME OVER YOU LOST:P", gameConfig.screenX/2, gameConfig.screenY/2+105);
    textSize(15);
...
function StepOnEnemy(obj1,obj2){
    ...
    obj1.killing=30;
    obj1.kills++;
    WHEN_MARIO_KILLS_ENEMY_BY_SR.play()
